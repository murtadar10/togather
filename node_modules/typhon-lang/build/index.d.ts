 ...
 */
type Operator = BitOr | BitXor | BitAnd | LShift | RShift | Add | Sub | Mult | Div | FloorDiv | Mod;
...
declare class AugLoad {
}
declare class AugStore {
}
declare class Param {
}
/**
 ...
 * Exponentiation '**'
 */
declare class Pow implements HasAstName {
}
/**
 * Bitwise Left Shift (<<)
 */
 ...
 * Bitwise NOT (~)
 */
declare class Invert implements HasAstName {
}
/**
 * Logical NOT (not)
 */
 ...
 * Unary Plus (+)
 */
declare class UAdd implements HasAstName {
}
/**
 * Unary Minus (-)
 */
declare class USub implements HasAstName {
}
declare class Eq {
}
declare class NotEq {
...
type Decorator = Attribute | Call | Name;
...
type AugAssignOperator = Add | Sub | FloorDiv | Div | Mod | LShift | RShift | BitAnd | BitXor | BitOr | Pow | Mult;
declare class AugAssign extends Statement {
    readonly range?: Range;
...
declare class Raise extends Statement {
    readonly range?: Range;
    type: Expression;
    inst: Expression;
    tback: Expression;
...
declare class TryExcept extends Statement {
    readonly range?: Range;
    body: Statement[];
...
declare class TryFinally extends Statement {
    readonly range?: Range;
    body: Statement[];
    finalbody: Statement[];
    constructor(body: Statement[], finalbody: Statement[], range?: Range);
}
declare class Assert extends Statement {
    readonly range?: Range;
    test: Expression;
    msg: Expression;
    constructor(test: Expression, msg: Expression, range?: Range);
}
declare class ImportStatement extends Statement {
    readonly range?: Range;
    names: Alias[];
...
declare class Exec extends Statement {
    readonly range?: Range;
    body: Expression;
...
declare class NonLocal extends Statement {
    readonly range?: Range;
    names: string[];
    constructor(names: string[], range?: Range);
}
...
declare class Pass extends Statement {
    readonly range?: Range;
...
declare class BoolOp extends Expression {
    readonly range?: Range;
    op: And;
    values: Expression[];
...
type UnaryOperator = UAdd | USub | Invert | Not;
declare class UnaryOp extends Expression {
...
declare class Lambda extends Expression {
    readonly range?: Range;
    args: Arguments;
    body: Expression;
    scopeId: number;
...
declare class IfExp extends Expression {
    readonly range?: Range;
    test: Expression;
    body: Expression;
    orelse: Expression;
...
declare class ListComp extends Expression {
    readonly range?: Range;
    elt: Expression;
 ...
 */
type CompareOperator = Eq | NotEq | Gt | GtE | Lt | LtE | Is | IsNot | In | NotIn;
...
type SubscriptContext = AugLoad | AugStore | Load | Store | Del | Param;
declare class Subscript extends Expression {
    readonly range?: Range;
    value: Expression;
...
declare function astFromExpression(n: PyNode): Expression;
/**
 * TODO: Documentation
 * @param n
 * @returns
 ...
 */
declare class UnexpectedTokenError extends ParseError {
     ...
     */
    constructor(tokenName: string, begin: LineColumn, end: LineColumn);
}
...
type SymbolFlags = number;
type DictionaryKind = 1 | 2 | 3 | 4;
...
type BlockType = 'class' | 'function' | 'module';
/**
...
export { Add, Alias, And, AnnAssign, Arguments, Assert, Assign, Attribute, AugAssign, AugAssignOperator, AugLoad, AugStore, BinOp, BitAnd, BitOr, BitXor, BlockType, BoolOp, BreakStatement, Call, ClassDef, Compare, CompareOperator, Comprehension, ContinueStatement, DEF_LOCAL, Decorator, Del, DeleteStatement, Dict, DictionaryKind, Div, Ellipsis, Eq, ExceptHandler, Exec, Expression, ExpressionStatement, ExtSlice, FloorDiv, ForStatement, FunctionDef, FunctionParamDef, GeneratorExp, Global, Gt, GtE, HasAstName, INumericLiteral, IfExp, IfStatement, ImportFrom, ImportStatement, In, Index, Interactive, Invert, Is, IsNot, IterationStatement, Keyword, LShift, Lambda, LineColumn, List, ListComp, Load, Lt, LtE, Mod, Module, Mult, Name, NonLocal, Not, NotEq, NotIn, Num, Operator, Or, Param, ParseError, Pass, Position, Pow, Print, PyNode, RShift, Raise, Range, RangeAnnotated, ReturnStatement, Slice, SourceKind, Statement, Store, Str, Sub, Subscript, SubscriptContext, Suite, Symbol, SymbolFlags, SymbolTable, SymbolTableScope, Target, TokenError, Tokens, TryExcept, TryFinally, Tuple, UAdd, USub, UnaryExpression, UnaryOp, UnaryOperator, UnexpectedTokenError, Visitable, Visitor, WhileStatement, WithStatement, Yield, astDump, astFromExpression, astFromParse, cstDump, parse, semanticsOfModule };
